 ...
 <body>
	...
	<form:form method="POST" modelAttribute="course" action="addedCourse">
		<table>
			...
			<tr>
				<td><form:input class="input"  path="classTimes" placeholder="Class Times" maxlength="30" required="true" /></td>
			</tr>
			<tr>
				<td><form:errors class="error" path="classTimes"/></td>
			</tr>
			<tr>
				<td><form:input class="input"  path="tutorTimes" placeholder="Tutor Times" maxlength="30" required="true" /></td>
			</tr>
			<tr>
